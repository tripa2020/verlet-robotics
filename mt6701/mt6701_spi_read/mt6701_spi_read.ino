/*
 * MT6701 SSI Raw Diagnostic - XIAO RP2040
 *
 * XIAO RP2040 SPI pins (use GPIO numbers in code):
 *   SCK:   D8 = GPIO2
 *   MISO:  D9 = GPIO4
 *   MOSI:  D10 = GPIO3 (not used for MT6701)
 *   CS:    D5 = GPIO7 (directly controlled)
 *
 * MT6701 wiring:
 *   B (CLK) -> XIAO D8 = GPIO2
 *   A (DO)  -> XIAO D9 = GPIO4
...
// XIAO RP2040 pin definitions (use GPIO numbers)
#define CS_PIN    6     // D5 = GPIO7
#define SCK_PIN   2     // D8 = GPIO2
#define MISO_PIN  4     // D9 = GPIO4
