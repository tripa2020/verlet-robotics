/*
 * MT6701 SSI Raw Diagnostic - XIAO RA4M1
 *
 * XIAO RA4M1 SPI pins (use D-pin numbers directly):
 *   SCK:   D8
 *   MISO:  D9
 *   MOSI:  D10 (not used for MT6701)
 *   CS:    D5 (directly controlled)
 *
 * MT6701 wiring:
 *   B (CLK) -> XIAO D8
 *   A (DO)  -> XIAO D9
...
// XIAO RA4M1 pin definitions (use D-pin numbers)
#define CS_PIN    5     // D5
#define SCK_PIN   8     // D8
